                  ...
                  children: [
                    InkWell(
                      ...
                      child: ref.watch(taskListServiceProvider).when(
                        ...
                        if (taskRate != null && taskRate.data!.isNotEmpty) {
                          final serviceDate = taskRate
                                  .data![0].order_items!.isNotEmpty
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '\t${taskRate!.data![0].order_items![0].period!.start_time} to ${taskRate!.data![0].order_items![0].period!.end_time}',
